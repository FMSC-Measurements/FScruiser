...
namespace FScruiser.Logic
{
    ...
    public class SampleSelectorFactory
    {
        ...
        public static void SerializeSamplerState(SampleGroupDO sampleGroup, SampleSelecter selector)
        {
        ...
        ///using the System.Exception.InnerException property.</exception>
        public static SampleSelecter DeserializeSamplerState(SampleGroupDO sampleGroup)
        {
        ...
        private SampleSelecter InitializePersistedSampler(SampleGroupDO sampleGroup)
        {
        ...
        private bool ValidateFreqSelecter(SampleGroupDO sampleGroup, IFrequencyBasedSelecter freqSelecter)
        {
        ...
        private SampleSelecter MakeThreePSampleSelector(SampleGroupDO sampleGroup)
        {
        ...
        private SampleSelecter MakeSystematicSampleSelector(SampleGroupDO sampleGroup)
        {
            SampleSelecter selecter = null;
            int iFrequency = (int)sampleGroup.InsuranceFrequency;
        ...
        private SampleSelecter MakeBlockSampleSelector(SampleGroupDO sampleGroup)
        {
            SampleSelecter selecter = null;
            int iFrequency = (int)sampleGroup.InsuranceFrequency;
            int frequency = (int)sampleGroup.SamplingFrequency;
